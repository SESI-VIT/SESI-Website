  ...
  return (
    ...
    >
      ...
      >
        <p
          className="copyright"
          style={{ color: "#ffffff", fontSize: "0.9rem", opacity: 0.8 }}
        >
        ...
        <div className="footer-icons" style={{ display: "flex", gap: "1.4rem" }}>
          ...
          <IconLink href="https://www.linkedin.com/company/sesi-vit/" ariaLabel="LinkedIn">
            <svg viewBox="0 0 24 24" width="22" height="22" fill="#ffffff">
          ...
          <IconLink href="mailto:sesi@vit.ac.in" ariaLabel="Email">
            <svg viewBox="0 0 24 24" width="22" height="22" fill="#ffffff">
