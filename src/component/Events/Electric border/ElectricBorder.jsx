...
const ElectricBorder = ({
  ...
  /**
   * ✅ Re-run animation when speed or chaos changes
   */
  useEffect(() => {
    updateAnim();
  }, [updateAnim]);
      ...
      <svg ref={svgRef} className="eb-svg" aria-hidden focusable="false">
        <defs>
          <filter id={filterId} colorInterpolationFilters="sRGB">
            <feTurbulence type="turbulence" baseFrequency="0.02" numOctaves="10" seed="1" />
            <feOffset dy="0">
              <animate attributeName="dy" values="700;0" dur="6s" repeatCount="indefinite" />
            </feOffset>

            <feTurbulence type="turbulence" baseFrequency="0.02" numOctaves="10" seed="2" />
            <feOffset dx="0">
